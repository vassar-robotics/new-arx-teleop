...
sleep 1
#x7s
gnome-terminal -t "L" -x  bash -c "cd ${workspace}; cd ../..; cd ROS2/R5_ws; source install/setup.bash && ros2 launch arx_r5_controller open_vr_single_arm.launch.py; exec bash;"
sleep 0.1
#VR
